import { ref,computed, createApp, defineComponent, getCurrentInstance, onBeforeUnmount, onMounted, PropType, reactive, provide, inject } from "vue";
...
const DropdownServiceProvider= (()=>{
  ...
  return {
    provide:(handler:{onClick:()=>void})=>{
      return provide(DROPDOWN_SERVICE_PROVIDER,handler)
    },
    inject:()=>{
